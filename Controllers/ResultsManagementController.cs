...
{
    public class ResultsManagementController : Controller
    {
        private readonly FgcBeTournamentDataContext _context;

        public ResultsManagementController()
        {
            _context = new FgcBeTournamentDataContext();
        }

        // GET: ResultsManagement
        ...
        // GET: ResultsManagement/Details/5
        ...
        // GET: ResultsManagement/Delete/5
        ...
        // POST: ResultsManagement/Delete/5
